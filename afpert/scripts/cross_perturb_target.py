...
from afpert.perturb import perturb_disjoint, perturb_alphamask, perturb_contacts

PERTURB_METHODS = {
    "afsample2": perturb_disjoint,
    "alphamask": perturb_alphamask,
    "custom": perturb_contacts
}
    ...
    for q, m in product(query_masks, msa_masks):
        ...
        for seed in range(n_seeds):
            ...
            if a3m_path.exists() and not overwrite:
                ...
                if perturb_fn != perturb_contacts:
                    perturbed = perturb_fn(a3m_entries, q / 100.0, m / 100.0, seed)
                else:
                    perturbed = perturb_contacts(a3m_entries, q / 100.0, m / 100.0, seed, target)
